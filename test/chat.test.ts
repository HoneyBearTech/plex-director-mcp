...
describe("buildHistoryMessages", () => {
  ...
  it("gives an assistant turn a readable summary of the table the user saw", () => {
    const messages = buildHistoryMessages([
      ...
      { role: "assistant", text: "see the table", movies: [row("Blade Runner 2049", ["4k Movies", "Movies"], 2017), row("Ender's Game", [], 2013), row("Unchecked", null, null)] },
    ]);
  ...
  it("summarises at most 25 rows and says how many were left out", () => {
    ...
    const text = String(buildHistoryMessages([{ role: "user", text: "q" }, { role: "assistant", text: "a", movies: many }])[1]!.content);
